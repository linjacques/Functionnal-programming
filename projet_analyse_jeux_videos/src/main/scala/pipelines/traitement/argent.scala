...
object Main {
  def main(args: Array[String]): Unit = {
    ...
    val df_sales = spark.read.parquet("C:\\Users\\couta\\Python project\\Functionnal-programming\\lakehouse\\bronze\\vgsales")
    val df_info = spark.read.parquet("C:\\Users\\couta\\Python project\\Functionnal-programming\\lakehouse\\bronze\\video_games")
    ...
    df_fini.write.mode("overwrite").parquet("C:\\Users\\couta\\Python project\\Functionnal-programming\\lakehouse\\argent\\data_merge")
